...
| `scripts/test_lib_env.sh`, `scripts/test_coverage_badge.py`, `scripts/test_check_config_xml.py`, `scripts/test_config_templates.py`, `scripts/test_systemd_unit.py`, `scripts/test_run_sh.py`, `scripts/test_perf_sh.py` | Tests behind `make test`; `fake-telnet-server.py` is their fake telnet endpoint fixture |
