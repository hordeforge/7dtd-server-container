...
| CI workflow + tests and helpers | `.github/workflows/ci.yml`, `Makefile`, `scripts/test_lib_env.sh`, `scripts/fake-telnet-server.py`, `scripts/check-config-xml.py`, `scripts/coverage_badge.py`, `scripts/test_coverage_badge.py`, `scripts/test_check_config_xml.py` |
